<template>
    ...
    <n-modal v-model:show="createTunnelModal">
        <n-card :style="widthStyle" title="選擇節點" :bordered="false" role="dialog" aria-modal="true">
            <n-alert type="info" style="bottom: 12px;">
                為確保您的體驗，請儘量選擇負載低，距離近的節點。
            </n-alert>
    ...
    <n-card style="margin-bottom: 20px;" title="功能列表">
...
const cards = ref([
    {
        title: '測試-Tunnel',
        id: '#15799',
        status: { type: 'success', label: '線上' },
        tags: ['測試1', '127.0.0.1:25565 - TCP'],
    ...
    },
    {
        title: '測試-Tunnel-2',
        id: '#1421',
        status: { type: 'warning', label: '離線' },
        tags: ['測試2', '127.0.0.1:25565 - TCP'],
        connection: 'hx.frp.one:25125',
        date: '2024-5-30 01:59:02',
        upload: 10.4,
        download: 10.9,
    ...
    },
    {
        title: '測試-Tunnel-3',
        id: '#91242',
        status: { type: 'error', label: '維護' },
        tags: ['測試3', '127.0.0.1:80 - HTTP'],
